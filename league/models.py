...
class Matches(models.Model):
    home_club = models.ForeignKey(Clubs, on_delete=models.CASCADE, related_name='home_matches')
    away_club = models.ForeignKey(Clubs, on_delete=models.CASCADE, related_name='away_matches')
...
class ClubSeasonStats(models.Model):
...
class Profile(models.Model):
    ...
    favourite_clubs = models.ManyToManyField(Clubs, blank=True)
